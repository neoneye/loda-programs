...
; Formula: a(n) = (6*n-1)%A314688(n)+4*n+1

mov $1,$0
seq $0,313088 ; Coordination sequence Gal.6.120.4 where G.u.t.v denotes the coordination sequence for a vertex of type v in tiling number t in the Galebach list of u-uniform tilings.
add $0,$1
