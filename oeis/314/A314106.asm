...
; Formula: a(n) = 2*(-n)+((2*(2*A315762(n)+(-n)+2))/3-1)

mov $1,$0
seq $0,315762 ; Coordination sequence Gal.6.627.5 where G.u.t.v denotes the coordination sequence for a vertex of type v in tiling number t in the Galebach list of u-uniform tilings.
add $0,$1
mul $0,4
add $0,1
div $0,3
