...
pow $1,$0
add $0,1
seq $0,65234 ; Fill a triangular array by rows by writing numbers 1 up to b(0), 1 up to b(1), etc., where b(n) are the decagonal numbers. The first elements of the rows form a(n).
sub $0,1
add $0,$1
