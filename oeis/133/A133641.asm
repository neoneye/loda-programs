...
lpb $0
  mov $2,$0
  add $2,1
  seq $2,168043 ; Let S(1)={1} and, for n>1 let S(n) be the smallest set containing x+1, x+2, and 2*x for each element x in S(n-1). a(n) is the number of elements in S(n).
  mov $0,0
  add $1,$2
lpe
add $1,1
