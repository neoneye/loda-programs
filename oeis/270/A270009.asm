...
lpb $3
  ...
  mov $0,$4
  add $0,$3
  seq $0,270006 ; Number of active (ON,black) cells in n-th stage of growth of two-dimensional cellular automaton defined by "Rule 5", based on the 5-celled von Neumann neighborhood.
  mov $2,$3
  mul $2,$0
  add $1,$2
  mov $5,$0
