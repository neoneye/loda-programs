...
lpb $5
  ...
  mov $4,$0
  max $4,0
  seq $4,270010 ; Number of active (ON,black) cells in n-th stage of growth of two-dimensional cellular automaton defined by "Rule 7", based on the 5-celled von Neumann neighborhood.
  mov $2,$5
  mul $2,$4
  add $1,$2
lpe
